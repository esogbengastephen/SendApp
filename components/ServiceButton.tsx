...
export const ServiceButton: React.FC<ServiceButtonProps> = ({
  ...
  return (
    ...
    >
      <div className="w-full aspect-square bg-ds-surface-soft dark:bg-ds-dark-surface-soft rounded-ds-lg flex items-center justify-center shadow-ds-soft group-active:scale-[0.98] transition-all duration-motion-fast ease-standard hover:opacity-90 border border-ds-border/50 dark:border-white/10">
        {useCustomIcon ? (
