-- ============================================
-- COMPLETE USER DATA WIPE - PRE-LAUNCH CLEANUP
-- Migration 015: Delete all users, transactions, and payment history
-- ============================================
...
-- Step 2: Delete ALL transactions (payment history)
DELETE FROM transactions;

-- Step 3: Delete ALL user wallets
DELETE FROM user_wallets;

-- Step 4: Delete ALL confirmation codes
DELETE FROM confirmation_codes;

-- Step 5: Delete ALL users (this will cascade delete any remaining user_wallets)
DELETE FROM users;
...
--   (SELECT COUNT(*) FROM user_wallets) as wallets_remaining,
--   (SELECT COUNT(*) FROM confirmation_codes) as codes_remaining;
